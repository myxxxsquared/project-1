...
class BaseNet(object):
    def __init__(self, params):
        self.input_size = params.input_size  # tuple  height * width * channels
...
class ResNet(BaseNet):
    def net_loading(self, **kwargs):
        ...
        with tf.variable_scope(tf.get_variable_scope(), custom_getter=cpu_variable_getter):
            ...
            activations = self._ConvLayer(activations, shape=(7, 7, 3, 64), padding=self.padding, strides=(1, 2, 2, 1), name='stage1')
            ...
            for i, stage in enumerate(['stage2', 'stage3', 'stage4', 'stage5']):
                ...
                for block in range(structure[1]):
                    ...
                    if block == 0 :
                        pooled = self._Pooling(activations,
                                               pooling='avg',
